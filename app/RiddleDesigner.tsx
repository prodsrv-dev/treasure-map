...
const legacyRiddleFragments = [
  ...
  "На синей бутыли устроился нос",
  "За стеклянной стеной колыхается свет",
];
...
Там ждёт продолжение — тайный клочок.`,
  ...
  if (
    ...
    return {
      ...
      riddle: `На синей бутыли уселся Носач,
Когтистый, горбатый, безмолвный силач.
Нажмёшь ему темя — он воду прольёт,
И снова над синей добычей замрёт.`,
    };
  }
...
Найди, где уснул огневой Ветрокрик.`,
  ...
  if (normalized.includes("аквари")) {
    return {
      ...
      riddle: `За стеклянной стеной колышется свет,
